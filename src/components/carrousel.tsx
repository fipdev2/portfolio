...
const Carrousel = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center px-4">
      <div className=" flex relative sm:w-[500px] lg:w-[600px] xl:w-[700px] w-[800px] min-h-[450px] xl:min-h-[394px] lg:min-h-[336px] md:min-h-[281px] items-center justify-center overflow-hidden">
